              ...
              <Collapsible key={chapter.id} defaultOpen={index === 0}>
                <Card className="p-0 overflow-hidden border-2 transition-all duration-200 hover:shadow-md gap-0">
                  <CollapsibleTrigger className="w-full group">
                    <div>
                      <CardContent className="p-6 hover:bg-muted transition-colors opacity-50 hover:opacity-100 flex items-center justify-between">
                        {/* left side (unchanged) */}
                        ...
                        {/* right side (badge + rotating icon) */}
                        <div className="flex items-center gap-3">
                          ...
                          <IconChevronDown className="size-5 text-card-foreground transition-transform duration-300 transform origin-center group-data-[state=open]:-rotate-90" />
                        </div>
                      </CardContent>
                    </div>
                  </CollapsibleTrigger>
